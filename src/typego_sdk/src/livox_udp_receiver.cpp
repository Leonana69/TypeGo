...
public:
    LivoxReceiver() : Node("livox_udp_receiver") {
        RCLCPP_INFO(get_logger(), "[LivoxReceiver] Initializing...");
        ...
        laserscan_publisher_ = this->create_publisher<sensor_msgs::msg::LaserScan>("scan", qos);
        ...
        recv_timer_ = this->create_wall_timer(
            ...
            std::bind(&LivoxReceiver::poll_socket, this));
